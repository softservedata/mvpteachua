...
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('спортивні секції', '/dev/static/images/categories/sport.svg', '#1890FF', '#1890FF', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('Танці', '/dev/static/images/categories/dance.svg', '#531DAB', '#F9F0FF', '#531DAB');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('студії раннього розвитку', '/dev/static/images/categories/improvement.svg', '#73D13D', '#73D13D', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('програмування, робототехніка, STEM', '/dev/static/images/categories/programming.svg', '#597EF7', '#597EF7', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('художні студії, мистецтво, дизайн', '/dev/static/images/categories/art.svg', '#9254DE', '#9254DE', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('вокальна студії, музика, музичні інструменти', '/dev/static/images/categories/music.svg', '#FF7A45', '#FF7A45', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('акторська майстерність, театр', '/dev/static/images/categories/theatre.svg', '#FF4D4F', '#FF4D4F', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('особистісний розвиток', '/dev/static/images/categories/self-improvement.svg', '#FADB14', '#FFF9D4', '#D46B08');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('журналістика, дитяче телебачення, монтаж відео, влогів', '/dev/static/images/categories/tv.svg', '#13C2C2', '#13C2C2', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('інше', '/dev/static/images/categories/other.svg', '#FFA940', '#FFA940', '#fff');
insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color) values ('центр розвитку', '/dev/static/images/categories/center.svg', '#F759AB', '#F759AB', '#fff');
